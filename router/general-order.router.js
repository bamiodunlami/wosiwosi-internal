...
// AJAX
.get("/orderInfo", generalOrder.listOrderAvailableToProcess) // (ajax call from orderToProcess.js) this function is used to check status and details of order already done in the orderAvailableToProcess page
